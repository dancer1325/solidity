...
* goal
  * | Solidity v0.5.0,
    ...
    * how to update affected code?
    * [backward compatible](#interoperability-with-older-contracts)

* [FULL list changes](https://github.com/ethereum/solidity/releases/tag/v0.5.0)

Semantic Only Changes
=====================

* TODO: This section lists the changes that are semantic-only, thus potentially
...
* backward compatible -- with -- contracts / written -- via -- older Solidity versions
